...
/* Enum: fann_errno_enum
	...
	FANN_E_FUNCTION_NA_FOR_SOM - A function that is not applicable to Self-Organizing Maps (SOMs), which is the type of the ANN passed in, was called
*/
enum fann_errno_enum
{
	FANN_E_NO_ERROR = 0,
 ...
 */ 
FANN_EXTERNAL void FANN_API fann_set_error_log(struct fann *ann, FILE * log_file);
...
/* Function: fann_get_errstr
   ...
   This function appears in FANN >= 1.1.0.   
 */ 
FANN_EXTERNAL char *FANN_API fann_get_errstr(struct fann *ann);
