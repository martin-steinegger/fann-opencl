...
#define FANN_GETP(type, paramstruct, name) \
FANN_EXTERNAL type FANN_API fann_get_ ## name(struct fann *ann) \
{ \
	return ann->paramstruct->name; \
}

#define FANN_SETP(type, paramstruct, name) \
FANN_EXTERNAL void FANN_API fann_set_ ## name(struct fann *ann, type value) \
{ \
	ann->paramstruct->name = value; \
}

#define FANN_GET_SETP(type, paramstruct, name) \
FANN_GETP(type, paramstruct, name) \
FANN_SETP(type, paramstruct, name)
