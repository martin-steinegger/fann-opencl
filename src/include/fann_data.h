...
enum fann_nettype_enum
{
    ...
    FANN_NETTYPE_SHORTCUT,   /* Each layer has connections to all following layers */
    FANN_NETTYPE_SOM,        /* Self-Organizing Map */
    FANN_NETTYPE_GNG,        /* Growing Neural Gas (a dynamic variant of SOM */
    FANN_NETTYPE_RECURRENT,  /* Each neuron can be connected to any other neuron */
	FANN_NETTYPE_FULLY_RECURRENT  /* Each neuron is connected to all other neurons */
};
...
static char const *const FANN_NETTYPE_NAMES[] = {
	...
	"FANN_NETTYPE_SOM",
	"FANN_NETTYPE_GNG",
    "FANN_NETTYPE_RECURRENT",
    "FANN_NETTYPE_FULLY_RECURRENT"
};

/* Enum: fann_som_topology_enum

   Definition of topology type if the network is a Self-Organizing Map

   See Also:
      <fann_get_som_topology_type>

   This constant appears in FANN >= 2.1.0
*/
enum fann_som_topology_enum
{
    FANN_SOM_TOPOLOGY_HEXAGONAL,  /* A hexagonal lattice */
    FANN_SOM_TOPOLOGY_RECTANGULAR /* A regular rectangular lattice */
};

/* Constant: FANN_SOM_TOPOLOGY_NAMES

   Constant array consisting of the names for the topology types for a SOM, so that the name of an
   topology type can be received by:
   (code)
   char *topology_type_name = FANN_SOM_TOPOLOGY_NAMES[fann_get_som_topology(ann)];
   (end)

   See Also:
      <fann_get_som_topology>

   This constant appears in FANN >= 2.2.0
*/
static char const *const FANN_SOM_TOPOLOGY_NAMES[] = {
        "FANN_SOM_TOPOLOGY_HEXAGONAL",
        "FANN_SOM_TOPOLOGY_RECTANGULAR"
};


/* Enum: fann_som_neighborhood_enum
   ...
   See Also:
      <fann_get_som_neighborhood>

   This constant appears in FANN >= 2.2.0
*/
enum fann_som_neighborhood_enum
{
    FANN_SOM_NEIGHBORHOOD_GAUSSIAN, /* A gaussian neighborhood with decreasing weight with increasing distance    */
    FANN_SOM_NEIGHBORHOOD_DISTANCE  /* A circular neighborhood with weight of 1 if within a distance, 0 otherwise */
};

/* Constant: FANN_SOM_NEIGHBORHOOD_NAMES

   Constant array consisting of the names for the neighborhood types for a SOM, so that the name of an
   neighborhood type can be received by:
   (code)
   char *neighborhood_type_name = FANN_SOM_NEIGHBORHOOD_NAMES[fann_get_som_neighborhood(ann)];
   (end)
   ...
   This constant appears in FANN >= 2.2.0
*/
static char const *const FANN_SOM_NEIGHBORHOOD_NAMES[] = {
        "FANN_SOM_NEIGHBORHOOD_GAUSSIAN",
        "FANN_SOM_NEIGHBORHOOD_DISTANCE"
};


/* Enum: fann_som_learning_decay_enum

   Definition of function determining decay of learning rate, if the network is a Self-Organizing Map. 
   See Also:
      <fann_get_som_learning_decay>

   This constant appears in FANN >= 2.2.0
*/
enum fann_som_learning_decay_enum
{
    FANN_SOM_LEARNING_DECAY_LINEAR, /* Linear decay of learning rate */
    FANN_SOM_LEARNING_DECAY_INVERSE /* Inverse-time decay function */
};

/* Constant: FANN_SOM_LEARNING_DECAY_NAMES

   Constant array consisting of the names for the learning decay types for a SOM, so that the name of an
   learning decay type can be received by:
   (code)
   char *learning_decay_type_name = FANN_SOM_LEARNING_DECAY_NAMES[fann_get_som_learning_decay(ann)];
   (end)
   ...
   This constant appears in FANN >= 2.1.0
*/
static char const *const FANN_SOM_LEARNING_DECAY_NAMES[] = {
        "FANN_SOM_LEARNING_DECAY_LINEAR",
        "FANN_SOM_LEARNING_DECAY_INVERSE"
};
...
struct fann_neuron;
FANN_EXTERNAL typedef void (FANN_API *fann_neuron_run) (struct fann * ann, struct fann_neuron * neuron);
FANN_EXTERNAL typedef void (FANN_API *fann_neuron_compute_error) (struct fann *ann, struct fann_neuron *neuron, fann_type *desired_output);
FANN_EXTERNAL typedef void (FANN_API *fann_neuron_backpropagate) (struct fann *ann, struct fann_neuron *neuron, fann_type *prev_layer_errors);
FANN_EXTERNAL typedef void (FANN_API *fann_neuron_update_weights) (struct fann *ann, struct fann_neuron *neuron);
FANN_EXTERNAL typedef void (FANN_API *fann_neuron_destructor) (struct fann_neuron *neuron);
FANN_EXTERNAL typedef void (FANN_API *fann_neuron_train_initialize) (struct fann *ann, struct fann_layer *layer, struct fann_neuron *neuron);
FANN_EXTERNAL typedef void (FANN_API *fann_neuron_save) (struct fann *ann, struct fann_layer *layer, struct fann_neuron *neuron,  FILE *conf);
FANN_EXTERNAL typedef int (FANN_API *fann_neuron_load) (struct fann *ann, struct fann_layer *layer, struct fann_neuron *neuron,  FILE *conf);
...
struct fann_neuron
{
	/*The number of inputs for this MIMO neuron*/
	unsigned int num_inputs;
	
	/*The number of outputs for this MIMO neuron*/
	unsigned int num_outputs;
	
	/*The first input from the layer*/
	fann_type *inputs;
	
	/* The first output in the layer output array,
	 * the value of the activation function applied to the sums
	 */
	fann_type *outputs;
	...
	*/
	...
	/*The total number of weights for this MIMO neuron*/
	unsigned int num_weights;
	
	/* The weight array */
	fann_type *weights;
	
    /* Used to store batch weights updates */
	fann_type *weights_deltas;
	...
	/* The number of times backpropagated input is accumulated */
	unsigned int num_backprop_done;
	...
	fann_neuron_destructor destructor;

	/* The run function */
	fann_neuron_run run;
	
	/* The traininig function backpropagate */
	fann_neuron_backpropagate backpropagate;
	
    /* The traininig function update_weights*/
	fann_neuron_update_weights update_weights;
	
	/* The compute_MSE function */
	fann_neuron_compute_error compute_error;

	/*initialize the neuron training data*/
	fann_neuron_train_initialize train_initialize;

	/*Save the neuron to the given file stream*/
	fann_neuron_save save;

	/*Load the neuron from the given file stream*/
	fann_neuron_load load;
 ...
 */
struct fann_layer;
FANN_EXTERNAL typedef void (FANN_API * fann_layer_destructor) (struct fann_layer *layer);
FANN_EXTERNAL typedef void (FANN_API * fann_layer_train_errors_initialize) (struct fann *ann, struct fann_layer *layer);
FANN_EXTERNAL typedef void (FANN_API * fann_layer_run) (struct fann *ann, struct fann_layer *layer);
FANN_EXTERNAL typedef void (FANN_API * fann_layer_save) (struct fann *ann, struct fann_layer *layer, FILE *conf);
FANN_EXTERNAL typedef int (FANN_API * fann_layer_load) (struct fann *ann, struct fann_layer *layer, FILE *conf);
struct fann_layer
{
	...
	/* The number of outputs including the bias outputs */
	unsigned int num_outputs;
	...
	/* Total number of MIMO neurons */
	unsigned int num_neurons;

	/* Used to contain the errors used during training
	* Is allocated during first training session,
	* which means that if we don't train, it is never allocated.
	*/
	fann_type *train_errors;
	
	/* The destructor function */
	fann_layer_destructor destructor;

	/* The initialize train errors array */
	fann_layer_train_errors_initialize initialize_train_errors;

	/*The forward iteration function*/
	fann_layer_run run;
	
	/*Save the layer to the given file stream*/
	fann_layer_save save;

	/*Load the layer from the given file stream*/
	fann_layer_load load;
...
/* Backpropagation algorithm parameters */
...
/* RPROP training algorithm parameters */
...
struct fann_som_params
{
  /* Number of inputs */
	unsigned int som_num_inputs;
	...
	float som_learning_rate;

	/* Learning rate constant */
	float som_learning_rate_constant;

	/* Topology of the network */
	enum fann_som_topology_enum som_topology;

	/* Neighborhood function */
	enum fann_som_neighborhood_enum som_neighborhood;

	/* Learning rate decay function */
	enum fann_som_learning_decay_enum som_learning_decay;


  /* Current radius of the neighborhood */
	float som_current_radius;

	/* Keeps track of the cell with the smallest
		distance from the current input */
	int som_closest_index; 

  float min_dist;
};

/* Growing Neural gas parameters */
struct fann_gng_params
{
	unsigned int gng_num_inputs;                            /* The number of inputs to the GNG */
	unsigned int gng_max_nodes;                             /* Max number of nodes to be used */
	unsigned int gng_max_age;                               /* Max age before node is deleted */
	float gng_local_error_reduction_factor;                 /* Scaling factor bet. 0 and 1 for err reduction of moved nodes*/
	float gng_global_error_reduction_factor;                /* Scaling factor bet. 0 and 1 for err reduction of all other nodes */
	float gng_winner_node_scaling_factor;                   /* Scaling factor bet. 0 and 1 for movement of winning node */
	float gng_neighbor_node_scaling_factor;                 /* Scaling factor bet. 0 and 1 for movement of neigh. nodes */
	unsigned int gng_iteration_of_node_insert;              /* Iteration number for new node insertion */
	
	unsigned int gng_num_cells;                             /* The number of cells in the GNG */
	unsigned int gng_current_iteration;                     /* Current iteration of the algorithm */
	int gng_closest_index;                                  /* Keeps track of the closest cell */
	int gng_second_closest_index;                           /* Keeps track of the second closest cell */
	int** gng_cell_edges;                                   /* Matrix that keeps track of the cell edges */
	float min_dist;
};

/* For fixed point */
struct fann_fixed_params
{
...
struct fann
{
	/* Parameters for FANN algorithms */
	struct fann_training_params *training_params;
	struct fann_backprop_params *backprop_params;
	struct fann_rprop_params	*rprop_params;
	struct fann_cascade_params	*cascade_params;
	struct fann_som_params		*som_params;
	struct fann_gng_params		*gng_params;
	struct fann_scale_params *scale_params;

	struct fann_error			*error;
	
#ifdef FIXEDFANN
	struct fann_fixed_params	*fixed_params;
#endif
	...
	/* Number of "normal" neurons (hidden + output) */
	unsigned int num_neurons;
...
FANN_EXTERNAL typedef int (FANN_API * fann_neuron_constructor) (struct fann *ann, 
		struct fann_layer *layer, struct fann_neuron *neuron, struct fann_neuron_descr *descr);
struct fann_neuron_descr
{
	/* Layer constructor */
	fann_neuron_constructor constructor;
	/* Neuron private data*/
	void* private_data;
	/* Number of outputs */
	unsigned int num_outputs;
	...
	fann_neuron_backpropagate backpropagate;
	/* The weights update function */
	fann_neuron_update_weights update_weights;
};

struct fann_layer_descr;
FANN_EXTERNAL typedef int (FANN_API * fann_layer_constructor) (struct fann *ann, 
		struct fann_layer *layer, struct fann_layer_descr *descr);
struct fann_layer_descr
{
	/* Layer constructor */
	fann_layer_constructor constructor;
	/* Layer descriptor private data */
	void* private_data;
	
	/* Desired numner of MIMO neurons in the layer */
	unsigned int num_neurons;
	struct fann_neuron_descr * neurons_descr;
};

/*FANN_EXTERNAL typedef int (FANN_API * fann_constructor) (struct fann *ann);*/
struct fann_descr
{
	/* Layer constructor */
	/*fann_constructor constructor;*/
	/* Layer descriptor private data */
	/*void* private_data;*/
	...
	struct fann_layer_descr * layers_descr;
};
#endif
